...
const Hero4 = () => {
  return (
    <section id="home" className={`flex md:flex-row flex-col md:pt-20 bounce-in-bottom`} >
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <div className="flex flex-row justify-between items-center w-full text-center ">
        ...
        Invest in a<br className="sm:block hidden" />{" "}
          <span className="text-gradient text-center">Child’s future</span>{" "}
        </h1>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 mt-10 relative `}>
      <img src={Kids} alt="billing" className="w-[100%]   h-[100%] relative z-[5] " />
