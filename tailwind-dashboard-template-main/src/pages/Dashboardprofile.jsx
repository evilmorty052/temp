  ...
  return (
    ...
    {/* <div className='bg-glass2 h-max rounded-full text-center px-2 py-1'>
      ...
      <script src="https://commerce.coinbase.com/v1/checkout.js?version=201807">
                ...
                <div class="flex justify-center col-span-full sm:col-span-6 xl:col-span-4  h-max relative ">
                <div class="rounded-lg shadow-lg bg-glass2 max-w-sm bg-glass2">
                  <a href="#!">
                    <img class="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/184.jpg" alt=""/>
                  </a>
                  <div class="p-6">
                    <h5 class="text-gray-900 text-xl font-medium mb-2 text-center">CIgar-Package</h5>
                ...
                <div class="rounded-lg shadow-lg bg-glass2 max-w-sm">
                  ...
                  <div class="p-6">
                    <h5 class="text-gray-900 text-xl font-medium mb-2">CIgar-Package</h5>
